...
To use Dragonboat, make sure to import the package __github.com/ik-tech/dragonboat/v3__. Also add "github.com/ik-tech/dragonboat/v3 v3.3.0" to the __require__ section of your project's go.mod file.
